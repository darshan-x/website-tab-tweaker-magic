          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="text-center border-border">
              <CardContent className="p-6">
                <div className="text-5xl font-bold text-[#FF4444] mb-2">40%</div>
            ...
            <Card className="text-center border-border">
              <CardContent className="p-6">
                <div className="text-5xl font-bold text-[#FF4444] mb-2">60%</div>
            ...
            <Card className="text-center border-border">
              <CardContent className="p-6">
                <div className="text-5xl font-bold text-[#FF4444] mb-2">24/7</div>
