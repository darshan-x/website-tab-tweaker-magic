...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background noise-overlay">
      {/* Background blur elements - Updated with new #FF4444 theme */}
      ...
      <div className="absolute top-40 right-10 w-72 h-72 bg-primary-red/25 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse-glow" style={{ animationDelay: '1s' }}></div>
      <div className="absolute -bottom-8 left-20 w-72 h-72 bg-primary-red/15 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse-glow" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Button asChild size="lg" className="pill-button bg-primary-red text-white hover:bg-primary-red/90 group">
                <Link to="/contact">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full max-w-lg mx-auto bg-gradient-to-br from-primary-red/10 to-primary-red/5 rounded-2xl p-8 glass">
              <SVGNodeAnimation />
            </div>
          </motion.div>
        </div>
